...
object Program extends App {
   ...
   *   val answer = "42"
   ***************************************************************************/
  val answer = "42" // instead of Concat(four, two)
  ...
  require(!(cThree matches "cc"))
  require(!(cThree matches "cccc"))
  require(!(cThree matches " "))
  ...
  require(!(pattern matches "bccc42")
   ...
   ***************************************************************************/
 val telNumber = '(' ~ digit{3} ~ ')' ~ digit{3} ~ '-' ~ digit{4}
 val telNumber = digit{5} ~ '-' ~ digit{4}
 
  require(telNumber matches "(202)456-1111")
  require(areaCode matches "95047-2827")        
